...
var AmazonSESAdapter = function (_MailAdapter) {
  ...
  function AmazonSESAdapter() {
    ...
    var _instanceObject = _possibleConstructorReturn(this, (AmazonSESAdapter.__proto__ || Object.getPrototypeOf(AmazonSESAdapter)));

    var _this = new _instanceObject(this, options);
